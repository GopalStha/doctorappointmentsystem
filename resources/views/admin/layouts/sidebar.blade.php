        ...
        <div class="sidebar-content">
            <div class="nav-container">
                ...
                @endif
                    ...
                    <div class="nav-item has-sub">
                        ...
                        <div class="submenu-content">
                            ...
                            <a href="{{ route('prescribed.patients') }}" class="menu-item">All Patients(prescriptions)</a>
                ...
                @endif
                    ...
                    @if (auth()->check() && auth()->user()->role->name === 'admin')
                        <div class="nav-item has-sub">
                            <a href="javascript:void(0)"><i class="ik ik-layers"></i><span>Patient Appointment</span>
                                <span class="badge badge-danger"></span></a>
                            <div class="submenu-content">
                                <a href="{{ route('patient') }}" class="menu-item">Today's Appointments </a>
                                <a href="{{ route('all.appointments') }}" class="menu-item">All Time Appointments</a>
